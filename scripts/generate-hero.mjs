...
const OUTFITS = [
  ...
  "a crisp white linen-blend button-down with the sleeves rolled twice above the elbow, tucked neatly into stone-colored chinos, with a matte black analog watch",
  "a lightweight steel-blue chambray short-sleeve button-down, tucked neatly into slim tan chinos",
  ...
  "a fine-check light-blue and white cotton button-down with the sleeves rolled twice, worn open-collar and tucked neatly into khaki chinos",
  "a soft sage-green linen button-down with the sleeves rolled above the elbow, worn open-collar and tucked neatly into cream chinos",
  "a lightweight white cotton short-sleeve button-down with a subtle textured weave, worn open-collar and tucked neatly into medium-gray chinos",
  "a warm sand-beige linen button-down, sleeves rolled twice, tucked neatly into dark navy chinos",
  ...
  "a heather-gray performance polo shirt in fine-gauge cotton, tucked neatly into dark charcoal chinos",
  "a soft white pique polo shirt with a clean collar roll, tucked into slim medium-blue chinos",
  "a muted forest-green polo shirt in lightweight cotton, tucked neatly into stone chinos",

  // Occasional clean dark denim (jeans are the exception, not the rule)
  "a crisp white linen-blend button-down with the sleeves rolled twice, tucked neatly into clean dark indigo selvedge jeans",
...
function buildPrompt({
  ...
  return [
    ...
    "PRESENTER ATTIRE (required): the presenter's shirt, whether a button-down or polo, must be neatly and fully tucked into the waistband all the way around for a polished, professional appearance. No untucked hems, loose shirttails, or partial tucks.",
...
function buildContentPrompt({
  ...
  return [
    ...
    "LABELS AND LOGOS (strict): the ONLY text permitted in the image is short product, service, or component NAMES \u2014 one to three words each \u2014 placed beside the element they label, plus small tastefully stylized approximations of those products' official logos (for example: Microsoft, Azure, Copilot, Copilot Studio, Power Platform, Dataverse, GitHub, VS Code, Teams, SharePoint, Dynamics 365, Foundry, Intune, Entra, ServiceNow). Render NO other text of any kind. Specifically forbidden: sentences, phrases, bullet lists, pros and cons panels, comparison tables, numbered steps, annotations, captions, callouts, tooltips, statistics, percentages, prices, currency symbols used as ratings, labels written on connector lines, code, JSON, and any placeholder or squiggle text. This constraint exists because the image cannot be fact-checked the way the article can: a confident, legible, WRONG claim in the artwork discredits the whole post. Convey every comparison, trade-off, cost difference, sequence, or caveat through composition, grouping, size, position, and color instead of writing it out. If an idea needs a sentence to express, express it structurally or leave it out. Do NOT invent words and do NOT produce jumbled or partial letters.",
    `Article title: ${title}.`,
    ...
    hasReferenceImages
      ...
      : "",
    "Strictly avoid: any recognizable individual human likeness, any portrait of a named person, any presenter or teacher figure, any whiteboard scene, any training room, any classroom, any auditorium or keynote stage, any audience of attendees, any headshot, any hand-drawn dry-erase-marker aesthetic (this is editorial illustration, not a whiteboard sketch), any sentence, phrase, bullet point, list, table, annotation or caption rendered as text in the image, any misspelled or garbled text, any brand or product logo used decoratively outside of its labeled diagram component, floating holograms, glowing brains, generic robots, abstract blue technology backgrounds, circuit-board wallpaper, cartoon or childish styling, and any anatomical impossibilities if small human figures do appear.",
